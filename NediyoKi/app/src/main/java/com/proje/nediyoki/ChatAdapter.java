...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolder>{
    ...
    public ChatAdapter(ArrayList<User> friends, Context context){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String friendUid = friends.get(position).uid;

        holder.btnAction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent detailIntent = new Intent(context, ChatDetailActivity.class);
                detailIntent.putExtra("frienduid", friendUid);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        TextView txtUserName, txtUid, txtDescription;
        Button btnAction;
